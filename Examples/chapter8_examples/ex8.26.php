<html><head><title>Extracting Values and Adding Prefixes
</title></head>
<body bgcolor="CCCFFF">
...
<?php
  ...
  $television = array("model"=>"Pan PX-44BBCCSTV",
   ...
   print "Variables created by <em>extract()</em> all have prefixes. Here are the values:<br /> ";
   print "$myvar_model, $myvar_type, $myvar_color, $myvar_size </em><br />";
